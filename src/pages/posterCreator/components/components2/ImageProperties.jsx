...
import useSingleCrestProperties from "../hooks/properties/useSingleCrestProperties";

export default function ImageProperties({ fabricRef }) {
  const { coords, handleInputChange } = useSingleCrestProperties(fabricRef);
  return (
    <>
