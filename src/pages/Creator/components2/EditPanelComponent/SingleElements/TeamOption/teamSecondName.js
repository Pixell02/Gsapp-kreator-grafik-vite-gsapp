...
const teamSecondName = (fabricRef, yourName, coords, themeOption, radioChecked) => {
  ...
  secondFont.load().then(() => {
    const secondName = new fabric.Text(secondTeamName, {
      ...
      originX:
        radioChecked === "radio1"
          ? coords.yourTeamSecondName.OriginX
          : coords.opponentName && coords.opponentName.OriginX
          ? coords.opponentName.OriginX
          : coords.opponentSecondName.OriginX,
      originY:
        radioChecked === "radio1"
          ? coords.yourTeamSecondName.OriginY
          : coords.opponentName && coords.opponentName.OriginY
          ? coords.opponentName.OriginY
          : coords.opponentSecondName.OriginY,
      top:
        radioChecked === "radio1"
          ? coords.yourTeamSecondName.Top
          : coords.opponentName && coords.opponentName.Top
          ? coords.opponentName.Top
          : coords.opponentSecondName.Top,
      left:
        radioChecked === "radio1"
          ? coords.yourTeamSecondName.Left
          : coords.opponentName && coords.opponentName.Left
          ? coords.opponentName.Left
          : coords.opponentSecondName.Left,
    ...
    if (
      secondName.width >
      (coords.opponentName ? coords.opponentName.ScaleToWidth : coords.yourTeamSecondName.ScaleToWidth)
    ) {
